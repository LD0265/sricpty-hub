...
local eggtype
b:Dropdown("Choose Egg Type",{"Starter (200)","Wood Egg (2500)","Jungle Egg (150k)","Forest Egg (1.5M)","Bee Egg (5M)","Swamp Egg (80M)","Snow Egg (800)"},true,function(x) --true/false, replaces the current title "Dropdown" with the option that t
   eggtype = x
end)
